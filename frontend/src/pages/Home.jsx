  ...
  return (
    <div className="flex flex-col min-h-screen pt-16">
      ...
      <section className="relative px-6 lg:px-8 py-24 sm:py-32 flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-accent/20 via-light-900 dark:via-dark-900 to-light-900 dark:to-dark-900"></div>
        <motion.div 
        ...
        >
          ...
          <p className="mt-6 text-lg md:text-xl leading-8 text-gray-600 dark:text-neutral-300 mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-x-6">
            ...
            <Link to="/register" className="text-sm font-semibold leading-6 text-gray-900 dark:text-white hover:text-accent transition-colors">
